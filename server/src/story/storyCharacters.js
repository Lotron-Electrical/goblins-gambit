export const STORY_CHARACTERS = {
  tavern: {
    regulars: [
      ...
      },
      {
        ...
        dialogue: {
          intro:
            "Don't let the apron fool you. I've knocked out bigger goblins than you with a serving tray.",
      ...
      },
      {
        ...
        dialogue: {
          intro:
            "These old bones still have some fight left in 'em. Come closer and find out.",
      ...
      },
      {
        ...
        dialogue: {
          intro:
            "I've been sitting on this stool since before you were born. Nobody moves me.",
      ...
      },
      {
        ...
        dialogue: {
          intro:
            "I'll bet three coppers I can beat you without breaking a sweat.",
    ...
    boss: {
      ...
      dialogue: {
        intro:
          "They call me the Tavern Champion for a reason. Nobody leaves this bar standing unless I say so.",
  ...
  hills: {
    regulars: [
      {
        ...
        dialogue: {
          intro:
            "The road's been long, but I've still got enough fight for the likes of you.",
      ...
      },
      {
        ...
        dialogue: {
          intro:
            "See this jaw? Took a boulder to the face and kept chewing. You won't do better.",
      ...
      },
      {
        ...
        dialogue: {
          intro:
            "The hill winds carry whispers about you. None of them are flattering.",
      ...
      },
      {
        ...
        dialogue: {
          intro:
            "Lost my leg to a wolf, my eye to a hawk, and my patience to fools like you.",
    ...
    boss: {
      ...
      dialogue: {
        intro:
          "Every traveler on these hills pays tribute to me. You'll pay in blood or coin. Your choice.",
        ...
        taunt:
          "My bandits are watching. Best make this entertaining before I finish you off.",
      },
    },
  },
  ...
  swamp: {
    regulars: [
      {
        ...
        dialogue: {
          intro:
            "Welcome to the bog. Mind your step, the mud here swallows the careless.",
      ...
      },
      {
        ...
        dialogue: {
          intro:
            "My little darlings are hungry, and you look positively full of blood.",
      ...
      },
      {
        ...
        dialogue: {
          intro:
            "Breathe deep. Those spores you're inhaling? That's just a taste of what's coming.",
    ...
    boss: {
      ...
      dialogue: {
        intro:
          "Come into my waters, little morsel. Mother Murk has been expecting you for a very long time.",
        ...
        taunt:
          "Struggling already? The deep waters haven't even noticed you yet.",
      },
    },
  },
  ...
  tundra: {
    regulars: [
      {
        ...
        dialogue: {
          intro:
            "Lost six toes to the cold and I'm still standing. What's your excuse gonna be?",
      ...
      },
      {
        ...
        dialogue: {
          intro:
            "Every icicle on this mountain answers to me. I'd watch where you step.",
      ...
      },
      {
        ...
        dialogue: {
          intro:
            "I move like the blizzard: silent, everywhere, and impossible to fight.",
      ...
      },
      {
        ...
        dialogue: {
          intro:
            "You don't want to meet the Yeti. Trust me, fighting his shadow is bad enough.",
    ...
    boss: {
      ...
      dialogue: {
        intro:
          "I am the Frost Warden, keeper of the frozen gate. None pass without my blessing, and I am not feeling generous.",
  ...
  cliffs: {
    regulars: [
      {
        ...
        dialogue: {
          intro:
            "The wind up here has a mind of its own. Lucky for me, we're old friends.",
      ...
      },
      {
        ...
        dialogue: {
          intro:
            "These claws have carved handholds into sheer rock. Imagine what they'll do to you.",
      ...
      },
      {
        ...
        dialogue: {
          intro:
            "I've been dangling off ledges since I could crawl. Danger is just Tuesday for me.",
      ...
      },
      {
        ...
        dialogue: {
          intro:
            "You didn't see me, did you? Nobody ever does until it's too late.",
    ...
    boss: {
      ...
      dialogue: {
        intro:
          "Welcome to the summit. I am the Cliff Lord, and gravity answers to me alone up here.",
        ...
        taunt:
          "Feeling dizzy? The altitude is nothing compared to what I'm about to do to you.",
      },
    },
  },
  ...
  volcano: {
    regulars: [
      {
        ...
        dialogue: {
          intro:
            "Every breath here tastes like ash and fury. I was born in this heat. You'll die in it.",
      ...
      },
      {
        ...
        dialogue: {
          intro:
            "My jaws are lined with molten rock. Care to test how fireproof you are?",
      ...
      },
      {
        ...
        dialogue: {
          intro:
            "I've walked through eruptions that leveled kingdoms. You're barely a spark.",
      ...
      },
      {
        ...
        dialogue: {
          intro:
            "My gaze alone has set forests ablaze. Try not to make eye contact.",
      ...
      },
      {
        ...
        dialogue: {
          intro:
            "I am the eruption given form. Unstoppable, explosive, and very, very angry.",
    ...
    boss: {
      ...
      dialogue: {
        intro:
          "I am the Molten King, forged in the heart of this volcano. Everything here burns at my command.",
        ...
        taunt:
          "The lava rises with my fury. How much longer can you withstand the heat?",
      },
    },
  },
};
