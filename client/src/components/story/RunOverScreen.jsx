...
export default function RunOverScreen() {
  const { runResult, returnToMenu, fetchTrophies, setStoryScreen } =
    useStoryStore();
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        {victory ? (
          <>
            ...
            <div
              className="absolute top-1/3 right-1/4 w-56 h-56 bg-yellow-500/5 rounded-full blur-3xl animate-pulse"
              style={{ animationDelay: "1s" }}
            />
            <div
              className="absolute bottom-1/3 left-1/2 w-80 h-80 bg-amber-400/5 rounded-full blur-3xl animate-pulse"
          ...
          <>
            ...
            <div
              className="absolute bottom-1/3 right-1/3 w-48 h-48 bg-red-800/5 rounded-full blur-3xl animate-pulse"
      ...
      <div className="relative z-10 flex flex-col items-center w-full max-w-md">
        ...
        {/* Title */}
        <h1
          className={`text-5xl md:text-6xl font-display mb-2 tracking-wide ${
            victory
        ...
        <div
          className={`w-40 h-px mb-3 bg-gradient-to-r from-transparent ${
        ...
        {/* Run stats card */}
        <div
          className={`w-full bg-gray-900/80 border rounded-2xl p-6 mb-6 backdrop-blur-sm ${
            victory ? "border-amber-600/30" : "border-gray-700/50"
          }`}
        >
          <h3
            className={`font-display text-lg mb-4 pb-2 border-b ${
              victory
          ...
          <div className="space-y-3">
            {[
              {
                label: "Battles Won",
                value: run.stats.battlesWon,
                color: "text-green-400",
                icon: "\u2694\uFE0F",
              },
              {
                label: "Battles Lost",
                value: run.stats.battlesLost,
                color: "text-red-400",
                icon: "\uD83D\uDCA5",
              },
              {
                label: "Levels Cleared",
                value: run.stats.levelsCompleted,
                color: "text-blue-300",
                icon: "\uD83C\uDFF0",
              },
              {
                label: "Enhancements",
                value: run.stats.enhancementsPicked,
              ...
              >
                ...
                <span
                  className={`${stat.color} font-bold text-lg tabular-nums`}
                >
                  {stat.value}
                </span>
              </div>
          ...
          {/* Final card showcase */}
          <div
            className={`mt-4 pt-4 border-t ${victory ? "border-amber-700/30" : "border-gray-700/40"}`}
          >
        ...
        {victory && (
          <div className="flex items-center gap-2 text-amber-400/80 text-sm mb-6 bg-amber-900/20 border border-amber-600/20 rounded-xl px-4 py-2">
            <span>{"\uD83C\uDFC6"}</span>
            <span>
              Your creature has been immortalized in the Trophy Cabinet!
            </span>
          </div>
        )}
