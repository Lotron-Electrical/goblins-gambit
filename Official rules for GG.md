# Official Rules for Goblins Gambit
...
There are four card types, each with a colour:
...
| Gamblid | * | * | * | ATK = avg opponent hand size x 100, DEF = own hand x 100, SP = ATK + DEF | 1 |
...
### Cursed Set
*Set Bonus (3/3): Swap your total SP with an opponent*

Individual Cursed pieces have **no effect** on their own. Wearing 2 pieces also grants **no bonus**. Only when all 3 Cursed pieces are equipped simultaneously (Cursed Beanie + Cursed Singlet + Cursed Crocs) does the set bonus activate, allowing you to **swap your total SP with 1 opponent** of your choice.
...
### Hessian Set
*Set Bonus: 2/3 pieces = 2 AP/round, 3/3 pieces = 3 AP/round*
...
### Rusty Set
*Set Bonus (3/3): Opponents can't play Creature (red) cards*
...
### Lucky Set
*Set Bonus (3/3): Extra 500 SP shield*
...
*This document should be updated when game rules change.*
